 ...
 * ----------------------------------------------------------------------
 */
 impl Quat {pub fn get_x(self) -> f64 {self.x}}

 impl Quat {pub fn get_y(self) -> f64 {self.y}}

 impl Quat {pub fn get_z(self) -> f64 {self.z}}

 impl Quat {pub fn get_w(self) -> f64 {self.w}}
/*
 * ----------------------------------------------------------------------
 *                    [setters]
 * ----------------------------------------------------------------------
